...
from cs336_basics.module import Embedding, Linear, RMSNorm, RotaryPositionalEmbedding, Softmax, SwiGLU
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return implement_train_bpe(input_path, vocab_size, special_tokens)
